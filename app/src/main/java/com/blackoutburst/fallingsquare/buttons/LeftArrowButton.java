...
public class LeftArrowButton extends Button {
    public LeftArrowButton(Texture texture, Texture textureSwitch, float x, float y, float width, float height, Colors color, int rotation, boolean switchColor, int timer) {
