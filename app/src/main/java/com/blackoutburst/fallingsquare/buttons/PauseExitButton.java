...
public class PauseExitButton extends Button {
    public PauseExitButton(Texture texture, Texture textureSwitch, float x, float y, float width, float height, Colors color, int rotation, boolean switchColor, int timer) {
